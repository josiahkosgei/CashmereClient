...
namespace CashmereDeposit.ViewModels
{
    internal class UserChangePasswordFormViewModel : FormViewModelBase
    {
          ...
          : base(applicationViewModel, conductor, callingObject, true)
        {
            ...
            User = _applicationUserRepository.GetByIdAsync(user.Id);
        ...
        private int ValidatePassword()
        {
            try
            {
                ...
                IList<PasswordHistory> list = _passwordHistoryRepository.GetByUserId(User.Id, passwordPolicy.HistorySize);
