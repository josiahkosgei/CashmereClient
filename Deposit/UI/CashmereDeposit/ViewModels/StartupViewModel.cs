...
namespace CashmereDeposit.ViewModels
{
    public class StartupViewModel : Conductor<Screen>, IShell, IDisposable
    {
        ...
        {
            return _iDeviceRepository.GetDevice(Environment.MachineName) ?? throw new Exception("Device: " + Environment.MachineName + " not set correctly in database. Device is null during start up.");
