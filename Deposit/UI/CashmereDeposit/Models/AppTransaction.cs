...
public class AppTransaction : PropertyChangedBase
{
        ...
        string currency)
    {
        ...
        //session.Transactions = _transactionRepository.AddAsync(_transaction);
        Currency = _currenciesRepository.GetByCode(currency);
    ...
    public Currency Currency
    {
        ...
        set
        {
            ...
            _currency = _currenciesRepository.GetByCode(value.Code);
    ...
    public TransactionTypeListItem TransactionType
    {
        ...
        set
        {
            ...
            Transaction.TxTypeNavigation = _transactionTypeListItemRepository.GetByIdAsync(value.Id); ;
