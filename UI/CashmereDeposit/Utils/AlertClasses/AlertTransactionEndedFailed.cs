...
// Type: CashmereDeposit.Utils.AlertClasses.AlertTransactionEndedFailed
...
namespace CashmereDeposit.Utils.AlertClasses
{
    public class AlertTransactionEndedFailed : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x => x.Result).Result;//4007);
        }
