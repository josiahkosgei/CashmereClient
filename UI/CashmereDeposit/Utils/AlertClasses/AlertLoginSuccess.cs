...
// Type: CashmereDeposit.Utils.AlertClasses.AlertLoginSuccess
...
namespace CashmereDeposit.Utils.AlertClasses
{
    internal class AlertLoginSuccess : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x=>x.Result).Result;//== 3002);
        }
