...
// Type: CashmereDeposit.Utils.AlertClasses.AlertTransactionEndedSuccess
...
namespace CashmereDeposit.Utils.AlertClasses
{
    public class AlertTransactionEndedSuccess : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x => x.Result).Result;//4006);
        }
