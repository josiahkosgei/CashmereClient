...
// Type: CashmereDeposit.Utils.AlertClasses.AlertDeviceStartupFailed
...
namespace CashmereDeposit.Utils.AlertClasses
{
    public class AlertDeviceStartupFailed : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x => x.Result).Result;//== 1101);
        }
