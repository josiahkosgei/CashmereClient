...
// Type: CashmereDeposit.Utils.AlertClasses.AlertTransactionStarted
...
namespace CashmereDeposit.Utils.AlertClasses
{
    public class AlertTransactionStarted : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x => x.Result).Result;//4004);
        }
