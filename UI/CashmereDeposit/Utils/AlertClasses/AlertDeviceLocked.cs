...
// Type: CashmereDeposit.Utils.AlertClasses.AlertDeviceLocked
...
namespace CashmereDeposit.Utils.AlertClasses
{
    public class AlertDeviceLocked : AlertBase
    {
          ...
          : base(device, dateDetected)
        {
            ...
            AlertType = _alertMessageTypeRepository.GetByIdAsync(ALERT_ID).ContinueWith(x=>x.Result).Result;//== 1400);
        }
