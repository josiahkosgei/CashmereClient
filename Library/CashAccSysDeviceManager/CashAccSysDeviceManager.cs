    ...
    public class CashAccSysDeviceManager : DeviceManagerBase
    {
            ...
            if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.IDLE ? 1 : 0) : 0) != 0)
            {
                if (HasEscrow)
                {
                    ...
                    else
                    {
                        ...
                        num = status1 == escrowStatus & status1.HasValue ? 1 : 0;
                    }
                    if (num == 0)
                        goto label_48;
                }
        ...
        label_48:
          ...
          e.ControllerStatus.Transaction.Status
            ...
            {
                ControllerStatus currentDeviceStatus2 = CurrentDeviceStatus;
                if ((currentDeviceStatus2 != null ? (currentDeviceStatus2.ControllerState == ControllerState.IDLE ? 1 : 0) : 0) != 0)
                {
                    ControllerStatus currentDeviceStatus3 = CurrentDeviceStatus;
                    int num1;
                    if (currentDeviceStatus3 == null)
                    ...
                    {
                        DeviceState? status3 = currentDeviceStatus3.NoteAcceptor?.Status;
                        DeviceState deviceState = DeviceState.IDLE;
                        num1 = status3 == deviceState & status3.HasValue ? 1 : 0;
                    }
                    if (num1 != 0)
                    {
                        ...
                        {
                            status1 = currentDeviceStatus4.Escrow?.Status;
                            EscrowStatus escrowStatus = EscrowStatus.IDLE_POS;
                        ...
                        if (num2 != 0)
                        {
                            ...
                            {
                                status2 = currentDeviceStatus5.Transaction?.Status;
        ...
        public bool CanTransactionStart
        {
            get
            {
                    ...
                    if (CurrentTransaction == null && CurrentState == DeviceManagerState.NONE)
                    {
                        ...
                        if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.IDLE ? 1 : 0) : 0) != 0)
                        {
                            ...
                            else
                            {
                                ...
                                DeviceState deviceState = DeviceState.IDLE;
                                num1 = status == deviceState & status.HasValue ? 1 : 0;
                            }
                            if (num1 != 0)
                            {
                                ControllerStatus currentDeviceStatus3 = CurrentDeviceStatus;
                                ...
                                else
                                {
                                    ...
                                    EscrowStatus escrowStatus = EscrowStatus.IDLE_POS;
                                    num2 = status == escrowStatus & status.HasValue ? 1 : 0;
                                }
                                if (num2 != 0)
                                {
                                    ControllerStatus currentDeviceStatus4 = CurrentDeviceStatus;
                                    ...
                                    DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.NONE;
                                    return status == transactionStatus & status.HasValue;
                                }
                            }
                        }
                    }
                ...
                return status1 == transactionStatus1 & status1.HasValue;
            }
        }
        ...
        public bool CanTransactionEnd
        {
            get
            {
                    ...
                    if (CurrentState == DeviceManagerState.NONE && CurrentTransaction?.CurrentTransactionResult != null)
                    {
                        ...
                        if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.IDLE ? 1 : 0) : 0) == 0)
                        {
                            ...
                            else
                            {
                                ...
                                num = status1 == deviceState & status1.HasValue ? 1 : 0;
                            }
                            if (num == 0)
                                goto label_23;
                        }
                        ...
                        else
                        {
                            ...
                            DeviceState deviceState = DeviceState.IDLE;
                            num1 = status1 == deviceState & status1.HasValue ? 1 : 0;
                        }
                        if (num1 == 0)
                        {
                            ControllerStatus currentDeviceStatus2 = CurrentDeviceStatus;
                        ...
                        if (HasEscrow)
                        {
                            ...
                            {
                                EscrowStatus? status2 = currentDeviceStatus2.Escrow?.Status;
                                EscrowStatus escrowStatus = EscrowStatus.IDLE_POS;
                                num2 = status2 == escrowStatus & status2.HasValue ? 1 : 0;
                            }
                            if (num2 == 0)
                                goto label_23;
                        }
                        ...
                        if (currentDeviceStatus4 == null)
                            return false;
                        DeviceTransactionStatus? status3 = currentDeviceStatus4.Transaction?.Status;
                        DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.ACTIVE;
                        return status3 == transactionStatus & status3.HasValue;
                    }
                label_23:
                    return false;
                }
                if (CurrentTransaction?.CurrentTransactionResult != null && CurrentState != DeviceManagerState.TRANSACTION_ENDING)
                {
                    ...
                    DeviceState? status;
                    int num1;
                    if (currentDeviceStatus1 == null)
                    {
                        num1 = 0;
                    }
                    else
                    {
                        status = currentDeviceStatus1.NoteAcceptor?.Status;
                        DeviceState deviceState = DeviceState.IDLE;
                        num1 = status == deviceState & status.HasValue ? 1 : 0;
                    }
                    if (num1 == 0)
                    {
                        ...
                        {
                            status = currentDeviceStatus2.NoteAcceptor?.Status;
                            DeviceState deviceState = DeviceState.OK;
                    ...
                    ControllerStatus currentDeviceStatus3 = CurrentDeviceStatus;
                    return currentDeviceStatus3 != null && currentDeviceStatus3.ControllerState == ControllerState.DROP;
                }
            label_36:
                return false;
            }
                    ...
                    if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.IDLE ? 1 : 0) : 0) != 0)
                    {
                        ...
                        if (num1 != 0)
                        {
                            ...
                            else
                            {
                                DeviceTransactionStatus? status = currentDeviceStatus4.Transaction?.Status;
                                DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.NONE;
                                num3 = status == transactionStatus & status.HasValue ? 1 : 0;
                            }
                            if (num3 != 0)
                                return true;
                            ControllerStatus currentDeviceStatus5 = CurrentDeviceStatus;
                    ...
                    if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.DROP ? 1 : 0) : 0) != 0)
                    {
                        ...
                        if (num1 != 0)
                        {
                            ...
                            else
                            {
                                ...
                                num3 = status1 == transactionStatus & status1.HasValue ? 1 : 0;
                            }
                            if (num3 == 0)
                            {
                                ControllerStatus currentDeviceStatus3 = CurrentDeviceStatus;
                                ...
                                {
                                    status1 = currentDeviceStatus3.Transaction?.Status;
                                    DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.ACTIVE;
                                    num2 = status1 == transactionStatus & status1.HasValue ? 1 : 0;
                                }
                                if (num2 == 0)
                                    goto label_22;
                            }
                            ...
                            return statusResultStatus1 == statusResultStatus2 & statusResultStatus1.HasValue;
                        }
                    }
                }
            label_22:
        ...
        public void PauseCount()
        {
            if (CurrentTransaction != null)
            {
                ...
                if ((currentDeviceStatus1 != null ? (currentDeviceStatus1.ControllerState == ControllerState.DROP ? 1 : 0) : 0) != 0)
                {
                    ...
                    else
                    {
                        ...
                        DeviceState deviceState = DeviceState.OK;
                        num1 = nullable1 == deviceState & nullable1.HasValue ? 1 : 0;
                    }
                    if (num1 != 0)
                    {
                        if (HasEscrow)
                        {
                            ...
                            else
                            {
                                ...
                                EscrowStatus escrowStatus = EscrowStatus.IDLE_POS;
                                num2 = nullable2 == escrowStatus & nullable2.HasValue ? 1 : 0;
                            }
                            if (num2 == 0)
                                goto label_25;
                        }
                        ...
                        else
                        {
                            ...
                            DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.COUNTING;
                            num3 = nullable3 == transactionStatus & nullable3.HasValue ? 1 : 0;
                        }
                        if (num3 == 0)
                        {
                            ControllerStatus currentDeviceStatus3 = CurrentDeviceStatus;
                            ...
                            {
                                nullable3 = currentDeviceStatus3.Transaction?.Status;
                                DeviceTransactionStatus transactionStatus = DeviceTransactionStatus.NONE;
                                num2 = nullable3 == transactionStatus & nullable3.HasValue ? 1 : 0;
                            }
                            if (num2 == 0)
                                goto label_25;
                        }
                        ...
                        else
                        {
                            DropStatusResultStatus? statusResultStatus1 = currentTransaction.CurrentTransactionResult?.CurrentDropStatus?.data?.DropStatusResultStatus;
                            DropStatusResultStatus statusResultStatus2 = DropStatusResultStatus.DROPPING;
                            num4 = statusResultStatus1 == statusResultStatus2 & statusResultStatus1.HasValue ? 1 : 0;
                        }
                        if (num4 != 0)
                        {
          ...
          null
                ...
                {
                    DeviceNoteAcceptor noteAcceptor = currentDeviceStatus5.NoteAcceptor;
                ...
                {
                    DeviceEscrow escrow = currentDeviceStatus6.Escrow;
                    if (escrow == null)
                    {
                        nullable2 = new EscrowStatus?();
                        nullable5 = nullable2;
                ...
                {
                    ControllerDeviceTransaction transaction = currentDeviceStatus7.Transaction;
                    if (transaction == null)
                    {
                        nullable3 = new DeviceTransactionStatus?();
                        nullable6 = nullable3;
        ...
        private DropStatusResult ProcessDropStatus(DropStatus dropStatus)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    num = statusResultStatus2 == statusResultStatus3 & statusResultStatus2.HasValue ? 1 : 0;
                }
                if (num != 0)
                {
                    ...
                    if (totalCount1 == nullable & totalCount1.HasValue == nullable.HasValue)
            ...
            foreach (var noteCount in dropStatus.Body.NoteCounts.NoteCount)
            {
            ...
            if (totalValue == valueOrDefault1 & nullable1.HasValue)
            {
                ...
                nullable1 = nullable2.HasValue ? new long?((long)nullable2) : new long?();
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    nullable3 = new int?(noteCount.Count);
                                }
                            }
                        }
                    }
        ...
        private DropResultResult ProcessDropResult(DropResult dropResult)
        {
            ...
            dropResultResult.TotalNumberOfNotes = (int)nullable1;
          ...
          TransactionStatusResponse transactionStatusResponse)
        {
            ...
            long nullable1 = (long)transactionStatusResponse?.Body?.DispensedAmount;
            statusResponseData.DispensedAmountCents = (long)nullable1;
            ...
            else
            {
                ...
                if (body == null)
                {
                    ...
                    nullable2 = body.LastDroppedAmount;
            }
            nullable1 = nullable2;
            statusResponseData.LastDroppedAmountCents = nullable1;
            ...
            nullable1 = (long)nullable3;
            statusResponseData.RequestedDispenseAmount = nullable1;
            ...
            nullable1 = (long)nullable4;
            statusResponseData.RequestedDropAmount = nullable1;
            long? nullable5;
            if (transactionStatusResponse == null)
            {
                nullable1 = new long();
            ...
            nullable1 = (long)nullable5;
            statusResponseData.TotalDroppedAmountCents = nullable1;
          ...
          DateTime EndDate)
        {
            ...
            return new List<(DateTime FileDate, FileInfo File)>();
        }

        private bool IsEscrowJam(List<(DateTime FileDate, FileInfo File)> logFiles, DateTime startDate)
        {
            foreach (FileInfo fileInfo in logFiles.Select<(DateTime, FileInfo), FileInfo>(x => x.Item2).ToList())
            {
