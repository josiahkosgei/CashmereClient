...
namespace Cashmere.Library.CashmereDataAccess
{
    ...
    {
        private IDepositorDBContextProcedures _procedures;

        public virtual IDepositorDBContextProcedures Procedures
        {
            get
            {
        ...
        public IDepositorDBContextProcedures GetProcedures()
        {
            return Procedures;
        }
    ...
    public partial class DepositorDBContextProcedures : IDepositorDBContextProcedures
    {
